...
<section class="banner-section">
    <div class="bg bg-image" style="background-image: url(assets/images/banner/inicio2.jpg);"></div>
    <div class="bg bg-overlay wow fadeIn" data-wow-delay="300ms"></div>

    <div class="auto-container" style="margin-top: -5%!important;">
        <div class="content-box">
            <h1 class="title wow fadeInUp" data-wow-delay="600ms">Grupo Universal</h1>
